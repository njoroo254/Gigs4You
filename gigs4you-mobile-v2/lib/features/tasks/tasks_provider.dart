...
class TasksProvider extends ChangeNotifier {
  ...
  /// Public entry point so widgets can push server-returned task updates
  /// into the provider without triggering a full reload.
  void updateTask(Task updated) => _updateLocal(updated);
