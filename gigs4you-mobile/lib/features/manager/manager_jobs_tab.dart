...
class _ManagerJobsTabState extends State<ManagerJobsTab>
  ...
  Widget _buildMarketplace(JobsProvider provider) {
    ...
    if (provider.jobs.isEmpty) return const Center(
      child: Text('No jobs', style: TextStyle(color: AppColors.text4)));
  ...
  Widget _buildMyPostings() {
    ...
    if (_myPostings.isEmpty) return Center(child: Column(
      mainAxisAlignment: MainAxisAlignment.center, children: [
        const Icon(Icons.work_outline, size: 48, color: AppColors.text4),
        const SizedBox(height: 12),
        const Text('No job postings yet', style: TextStyle(color: AppColors.text3, fontWeight: FontWeight.w600)),
          ...
          child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min,
            ...
            Row(children: [
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('Category', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.text3)),
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('Budget type', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.text3)),
                const SizedBox(height: 4),
                DropdownButtonFormField<String>(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (job['location'] != null) ...[
          ...
          Row(children: [
            ...
            Text(job['location'], style: const TextStyle(fontSize: 12, color: AppColors.text4)),
          ]),
        ],
        const SizedBox(height: 8),
        Row(children: [
          Text('${job['applicantCount'] ?? 0} applicants', style: const TextStyle(fontSize: 12, color: AppColors.text3)),
          const Spacer(),
